...
#include "ev3api.h"
#include "../../../../../../target/ev3_gcc/pil/include/platform_interface_layer.h"
#include "../../../../../common/ev3api/src/api_common.h"
...
int32_t _ev3_motor_get_counts(motor_port_t port) {
...
ER _ev3_motor_reset_counts(motor_port_t port) {
	ER ercd;
...
ER _ev3_motor_set_power(motor_port_t port, int power) {
	ER ercd;
